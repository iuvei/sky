    ...
    <div class="content">
      <yd-cell-group class="form_ipt">
        <yd-cell-item>
          ...
          <input slot="right" type="password" placeholder="请输入旧的登录密码" v-model="oldPW">
        </yd-cell-item>
        <yd-cell-item>
          <span slot="left">新的密码</span>
          <input slot="right" type="password" placeholder="请输入新的密码" v-model="newPW1">
        </yd-cell-item>
        <yd-cell-item>
          <span slot="left">确认密码</span>
          <input slot="right" type="password" placeholder="请再次输入您的密码" v-model="newPW2">
        </yd-cell-item>
      </yd-cell-group>
