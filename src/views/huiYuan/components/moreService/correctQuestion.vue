    ...
    <div class="content" v-show="isShow">
      <yd-cell-group class="form_ipt">
        <yd-cell-item>
          ...
          <select slot="right" v-model="questionOne">
            <option :value="index" v-for="(item, index) in questionArr" :key="index">{{item}}</option>
          </select>
        </yd-cell-item>
        <yd-cell-item>
          <span slot="left">答案</span>
          <input slot="right" type="text" placeholder="请输入答案" v-model="answerOne">
        </yd-cell-item>
        <yd-cell-item>
          <span slot="left">问题二</span>
          <select slot="right" v-model="questionTwo">
            <option :value="index" v-for="(item, index) in questionArr" :key="index">{{item}}</option>
          </select>
        </yd-cell-item>
        <yd-cell-item>
          <span slot="left">答案</span>
          <input slot="right" type="text" placeholder="请输入答案" v-model="answerTwo">
        </yd-cell-item>
        <yd-cell-item>
          <span slot="left">问题三</span>
          <select slot="right" v-model="questionThree">
            <option :value="index" v-for="(item, index) in questionArr" :key="index">{{item}}</option>
          </select>
        </yd-cell-item>
        <yd-cell-item>
          <span slot="left">答案</span>
          <input slot="right" type="text" placeholder="请输入答案" v-model="answerThree">
        </yd-cell-item>
      </yd-cell-group>
      <p class="btn">
        <button @click="submitData" v-show="show">确定</button>
        <button @click="newSubmitData" v-show="!show">立即修改</button>
      </p>
    </div>
    <div class="content" v-show="!isShow">
      <yd-cell-group class="form_ipt">
        <yd-cell-item>
          <span slot="left">问题一</span>
          <select slot="right" v-model="verifyQuestionOne">
            <option :value="index" v-for="(item, index) in questionArr" :key="index">{{item}}</option>
          </select>
        </yd-cell-item>
        <yd-cell-item>
        ...
        <yd-cell-item>
          <span slot="left">问题二</span>
          <select slot="right" v-model="verifyQuestionTwo">
            <option :value="index" v-for="(item, index) in questionArr" :key="index">{{item}}</option>
          </select>
        </yd-cell-item>
        <yd-cell-item>
        ...
        <yd-cell-item>
          <span slot="left">问题三</span>
          <select slot="right" v-model="verifyQuestionThree">
            <option :value="index" v-for="(item, index) in questionArr" :key="index">{{item}}</option>
          </select>
        </yd-cell-item>
        <yd-cell-item>
...
export default {
  ...
  methods: {
    submitData() {
      let isPass = this.answerOne && this.answerTwo && this.answerThree
    ...
    verifyData () {
      ...
      let isPass = this.verifyAnswerOne && this.verifyAnswerTwo && this.verifyAnswerThree
      if(!isPass) {
        this.$dialog.toast({mes: '请填写正确密保答案'})
        return
      }
