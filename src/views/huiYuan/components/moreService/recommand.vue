    ...
    <div class="recommand_box">
        ...
        <div class="recommand">
            <div class="download_box">
                ...
                <button v-clipboard:copy="'http://upload.bxvip588.com/sg04/Uploads/qrcode/fa5be9091f631c3a5dbc7cad2a3e86f7.png'" v-clipboard:success="onCopy" v-clipboard:error="onError">复制</button>
            </div>
            <div class="fenxiang_box social-share">
                <div class="qq_btn" @click="shareToqq()">
                    <img src="../../../../../src/img/more_settings/QQ.png" alt="">
                    <div class="share_content">
                        <p>复制下载链接，</p>
                        <p>并打开QQ推送给好友</p>
                    </div>
                </div>
                <div class="weixin_btn" @click="shareToWx()">
                    <img src="../../../../../src/img/more_settings/weixin.png" alt="">
                    <div class="social-share">
                         <div class="share_content" data-sites="weibo,qq,qzone,tencent">
                            <p> 复制下载链接，</p>
                            <p>并打开微信推送给好友</p>
                        </div>
                    </div>
            ...
            <div class="vscode_box">
                        <div class="title">
                            <span class="apple">
                                <img src="../../../../../src/img/more_settings/ios.png" alt="">
                                <span>苹果二维码</span>
                            </span>
                            <span class="android">
                                <img src="../../../../../src/img/more_settings/android.png" alt="">
                                <span>安卓二维码</span>
                            </span>
                        </div>
                        <div class="vscode">
                            <span class="apple_vs" href="http://upload.bxvip588.com/sg04/Uploads/qrcode/fa5be9091f631c3a5dbc7cad2a3e86f7.png">
                                <img src="http://upload.bxvip588.com/sg04/Uploads/qrcode/fa5be9091f631c3a5dbc7cad2a3e86f7.png" alt="iphoneVscode">
                            </span>
                            <span class="android_vs" href="http://upload.bxvip588.com/sg04/Uploads/qrcode/fa5be9091f631c3a5dbc7cad2a3e86f7.png">
                                <img src="http://upload.bxvip588.com/sg04/Uploads/qrcode/fa5be9091f631c3a5dbc7cad2a3e86f7.png" alt="androidVscode">
                            </span>
                        </div>
                        <div class="save_btn">
...
export default {
    ...
    data(){
        return{
            ...
            config: {  
                value: 'www.baidu.com',
                logo:'http://upload.bxvip588.com/sg04/Uploads/qrcode/fa5be9091f631c3a5dbc7cad2a3e86f7.png'
            },
            // show1:false
        }
    },
    ...
    methods:{
        shareToqq(){
            ...
            const url_scheme = '//share/to_fri?src_type=web&version=1&file_type=news&share_id=1103437993&title=' + btoa(share.title) + '&thirdAppDisplayName=5o6M5LiK55CG5bel5aSn&url=' + btoa(share.share_url) + '&description=' + btoa(share.desc);
        ...
        saveCode(){
            var a = document.getElementsByClassName("apple")[0];
            console.log(a);
            a.onclick();
        },
        downloadClick () {
