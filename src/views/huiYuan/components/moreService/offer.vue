<template>
    <div class="offer_main_body">
        <publicHead :title="funcName" :timeText="chooseTimeText" @chooseTimeShow="changeState"   @pullDown="optionsShow"  :type="1"></publicHead>
        <div class="betRecord">
          <yd-tab class="openAccount_main_content" v-model="state" :prevent-default="false" :item-click="itemClick">
              <yd-tab-panel label="现金">
                 <ul class="offer_card">
                  <li class="offer_card_list" v-for="(item,index) in cashlist" :key="index">
                     <img v-show="1" src="../../../../../src/img/welfareTask/youhui_orange.png" alt="">
              ...
              <yd-tab-panel label="代金券">
                 <ul class="offer_card">
                  <li class="offer_card_list" v-for="(item,index) in voucherlist" :key="index">
                     <img v-show="item.btime" src="../../../../../src/img/welfareTask/youhui_orange.png" alt="">
                     <img v-show="!item.btime" src="../../../../../src/img/welfareTask/youhui_gray.png" alt="">
                    <div class="offer_card_content">
                      <div class="content_top">
                        <div class="left">
                          <p class="offer_tit">{{item.title}}</p>
                      ...
                      <div class="contetn_bottom">
                        <p class="content_bottom_main"><span class="mount">需打码量：<i>0</i></span><button :class="{'used':item.btime == 0}" v-show="state">{{item.status}}</button></p>
                      </div>
                    </div>
                  </li>
                </ul>
