<template>
  <div class="moreSetting_main_body">
    ...
    <yd-cell-group class="moreSetting_main_content">
      <yd-cell-item>
        <img src="../../../../img/more_settings/open_shaking.png" alt="" slot="left">
        <span slot="left">开启摇一摇震动</span>
        <yd-switch v-model="defaultShake" slot="right"></yd-switch>
      </yd-cell-item>
      <yd-cell-item>
        <img src="../../../../img/more_settings/open_sound.png" alt="" slot="left">
        <span slot="left">开启触摸音效</span>
        <yd-switch v-model="defaultSound" slot="right"></yd-switch>
      </yd-cell-item>
      <!-- <yd-cell-item>
      ...
      <yd-cell-item arrow type="link" href="/moreService/aboutUs">
        <img src="../../../../img/more_settings/about_us.png" alt="" slot="left">
        <span slot="left">关于我们</span>
      </yd-cell-item>
      <p class="log_out" v-show="userinfo.isLogin">
