        ...
        <yd-list theme="1" slot="list">
            ...
            <ul class="thelist_list" v-for="(item,index) in list" :key="index" v-if="index >= 0">
                <li>
                    ...
                    <div class="number_r">
                        <span v-for="(items,indexs) in item.balls.split('+')" :key="indexs" :style="{color:`${ballToColor(parseInt(items))}`}">
                            <i class="and_such" v-if="indexs == 1 && item != ''">+</i>
                            <i class="and_such" v-if="indexs == 2 && item != ''">+</i>
                            <i class="and_such" v-if="indexs == 3 && item != ''">=</i>
                            {{items == '' ? '正在开奖' : items}}
                        </span>
                    </div>
