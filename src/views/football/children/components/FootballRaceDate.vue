<template>
  <div class="race-date">
    ...
    <vue-event-calendar class="race-date-calendar" :events="events" @day-changed="handleDayChanged" @month-changed="handleMonthChanged"></vue-event-calendar>
    <footer>
      <span class="cancel" @click="$emit('close')">取消</span>
      <span class="confirm" @click="submit">确认</span>
    </footer>
  </div>
</template>
<script>
