<template>
  <div class="agencyCenter_main_body">
    ...
    <div class="agencyCenter_main_content" v-if="show">
      <div class="bg_wall">
        <img src="../../img/daili/agency_center.jpg" alt="">
      </div>
    ...
    <div class="apply_agent" v-if="!show">
      <h3>什么是代理？</h3>
      ...
      <p v-if="checking" class="checking">审核时间24小时之内给以回复，请注意接收信息</p>
    </div>
  </div>
</template>
<script>
