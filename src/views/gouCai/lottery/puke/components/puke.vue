        ...
        <div class="balls">
          <ul v-if="balls.length > 1">
            <li v-for="(item,index) in balls" :key="index">
              <span class="card">
                <img  :src="require('../../../../../img/puke/card/' + calchs(item) + '_' + calcdx(item) + '.png')" alt="">
              </span>
            </li>
          </ul>
          <ul v-else>
            ...
            <div class="history">
              <ul>
                ...
                <li  v-for="(item, index) in kjBalls" v-if="index <= 7" :key="index">
                  ...
                  <span  v-if="Array.isArray(item.balls)&&item.balls.length" class="kaijiang">
                    <span  v-for="(num,dex) in item.balls" :key="dex">
                      <img :src="require('../../../../../img/puke/card/'+ calchs(num) + '_' + calcdx(num) + '.png')" alt="">
                    </span>
                  </span>
                  <span v-else class="kaijiang" >{{'正在开奖'}}</span>
